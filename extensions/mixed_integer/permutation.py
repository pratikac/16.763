...
from cvxpy.constraints import leq_constraint, eq_constraint
...
class permutation(NonCvxVariable):
    ...
    def constraints(self):
        constraints = [LeqConstraint(0, self._objective()),
        ...
        for i in range(self.size[0]):
            ...
            constraints += [LeqConstraint(row_sum, 1),
                            LeqConstraint(col_sum, 1)]
        return constraints
