...
\ilist{
    ...
    \item The master problem is constructed using this set of columns while the sub-problem is a shortest path problem (with modified costs as shown in Eqn.~\eqref{eqn:rcsp_sub_problem}. The solution of the sub-problem creates a new path that is added as a column in the master.
